...
public class GameEngine
{
    ...
    public void tick()
    {
        for (Agent a :map.getAgents())
        {
            ...
            Move move = TeleportCoordinator.teleportIfLegal(a, startPoint, endPoint, map);
            if(move != null)
            {
                a.updateLocation(a.getPosition().add(move.getDeltaPos()));
                a.updateDirection(move.getEndDir());
            }
